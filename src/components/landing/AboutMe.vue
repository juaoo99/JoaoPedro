    ...
    <div class="lg:px-20 px-10 lg:flex w-full lg:items-center lg:justify-around gap-5">
        ...
        <div class="items-center lg:w-1/2">
            ...
            <p class="font-light text-lg text-pretty mt-5" v-animateonscroll="{ enterClass: 'animate-enter fade-in-10 slide-in-from-b-20 animate-duration-1000' }">
                <span class="text-2xl font-bold py-10">Atualmente </span> moro no Rio Grande do Sul e por três fiz parte do time de desenvolvimento da Flux Tecnologia. Casado e pai de uma linda menina. Adoro cinema, música e ler. De Attack on Titan
                ao cinema do Denis Villanueve, de Rachmaninoff ao Kendrik Lamar, e das documentações intermináveis das linguagens e ferramentas que uso até Dostoiévski.
            </p>
            <p class="font-light text-lg text-pretty mt-5" v-animateonscroll="{ enterClass: 'animate-enter fade-in-10 slide-in-from-b-20 animate-duration-1000' }">
